...
$content = wp_trim_words( get_the_excerpt(), TripferyTheme::$options['locations_arexcerpt_limit'], '' );
				...
				<?php
					if ( has_post_thumbnail() ){
						...
						if ( !empty( TripferyTheme::$options['no_preview_image']['id'] ) ) {
							...
							echo '<img class="wp-post-image" src="' . TripferyTheme_Helper::get_img( 'noimage_470X555.jpg' ) . '" alt="'.get_the_title().'" loading="lazy" >';
						}
					}
				?>
			</a>			
