...
<div id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?> data-wow-duration="1.5s">
	<div class="blog-box <?php echo esc_attr($img_class); ?> <?php echo esc_attr($preview); ?>">
		...
		<div class="entry-content">
			...
			<ul class="entry-meta">
				<?php if ( TripferyTheme::$options['blog_author_name3'] ) { ?>
				...
				<li><span class="post-views meta-item "><?php echo tripfery_views(); ?></span></li>
				<?php } ?>
			</ul>
			<?php } ?>	
			<h2 class="entry-title"><a href="<?php the_permalink();?>"><?php the_title();?></a></h2>
			<?php if ( TripferyTheme::$options['blog_content3'] ) { ?>
