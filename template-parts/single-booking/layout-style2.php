...
<div class="container">
    ...
    <div class="row align-items-center rt-booking-price-area">
        ...
        <div class="col-lg-4 col-xl">
            <div class="activity-price d-flex">
                <div class="price-area">
                    ...
                    <?php } else { ?>
                        ...
                        <!-- <?php } ?> <span class="stay-time">/night</span> -->
                </div>
            </div>
        </div>
    </div>
            ...
            <?php if (!empty($booking_highlights)) { ?>
                <div class="info-card highlight-content">
                    <?php if (!empty($highlights_title)) { ?>
                        <h3 class="info-card-title rt-mb-10"><?php echo esc_html($highlights_title); ?></h3>
                    <?php } ?>
                ...
                <div class="info-card included-content">
                    ...
                    <div class="rt-included-meta-text">
                        <ul class="col info-list rt-mp-0">
                            ...
                            ?>
                                <li class="info-list-item d-flex align-items-center"><i class="fa-solid fa-circle info-list-icon"></i><?php echo esc_html($included['rules_name']) ?></li>
                            <?php } ?>
                        </ul>
                        ...
                        <ul class="col info-list rt-mp-0">
                            ...
                            ?>
                                <li class="info-list-item d-flex align-items-center"><i class="fa-solid fa-circle info-list-icon"></i><?php echo esc_html($excluded['rules_name']) ?></li>
                            <?php } ?>
                        </ul>
                    </div>
