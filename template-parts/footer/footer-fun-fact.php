        ...
        <div class="fun-fact-area">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-<?php echo esc_attr($colum); ?> col-md-6 mb-4 mb-lg-0 wow fadeInUp animated" data-wow-delay="0.2s" data-wow-duration="1.2s">
                    ...
                    <div class="col-lg-<?php echo esc_attr($colum); ?> col-md-6 mb-4 mb-lg-0 wow fadeInUp animated" data-wow-delay="0.4s" data-wow-duration="1.3s">
                        <div class="single-fun-fact">
                    ...
                    <div class="col-lg-<?php echo esc_attr($colum); ?> col-md-6 mb-4 mb-lg-0 wow fadeInUp animated" data-wow-delay="0.6s" data-wow-duration="1.3s">
                        <div class="single-fun-fact">
