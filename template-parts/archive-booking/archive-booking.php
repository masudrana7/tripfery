...
if (class_exists('BABE_Functions')) {
    ...
    if (!is_wp_error($loc_cats && $loc_cats)) {
        $args = array(
            'post_type' => 'to_book',
            'posts_per_page' => -1,
            'paged'             => $paged,
...
?>
        <div id="primary" class="content-area">
            <div class="container">
                    ...
                    <?php if (!empty($lat_code || $long_code)) { ?>
                        <div class="col-md-6">
                            <div class="rt-booking-map">
                                <div id="google_map_address_with_direction" data-obj-id="<?php echo $get_id; ?>" data-lat="<?php echo $lat_code; ?>" data-lng="<?php echo $long_code; ?>" data-address="<?php echo wp_kses_post($loc_cat->name) ?>">
                ...
                <h3><?php echo esc_html('Discover now', 'tripfery') ?></h3>
