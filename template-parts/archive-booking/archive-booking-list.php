<?php if (class_exists('BABE_Functions')) {
...
?>
    <div class="rt-fillter-inner rt_list_service">
        <div class="row">
            <?php
            $args = array(
                'post_type'            => 'to_book',
            ...
            foreach ($posts as $post) {
                ...
                <div class="col-12">
                    <div class="listing-card d-flex flex-column flex-md-row align-items-center">
                        <div class="rt-service-image"><?php echo wp_kses_post($image); ?></div>
                        <div class="listing-card-content flex-grow-1">
