...
<div class="header-menu header-top" id="header-middlebar">
	<div class="container">
		<div class="menu-full-wrap">
			<?php if ( TripferyTheme::$options['email_icon'] || TripferyTheme::$options['phone_icon'] ) { ?>
			<div class="header-info-wrap">
				...
				<div class="header-info header-email">
					...
					<div class="info-text email">
						<a href="mailto:<?php echo esc_attr( TripferyTheme::$options['email'] );?>"><?php echo wp_kses( TripferyTheme::$options['email'] , 'alltext_allow' );?></a>
					</div>
				</div>
				...
				<div class="header-info header-phone">
					...
					<div class="info-text phone-no">
						<a href="tel:<?php echo esc_attr( TripferyTheme::$options['phone'] );?>"><?php echo wp_kses( TripferyTheme::$options['phone'] , 'alltext_allow' );?></a>
					</div>
				</div>
				<?php } ?>
			</div>
			...
			<div class="menu-icon">
				<div class="site-branding">
					<a class="light-logo" aria-label="Light Logo" href="<?php echo esc_url( home_url( '/' ) );?>"><?php echo wp_kses( $tripfery_dark_logo, 'allow_link' ); ?></a>
					<a class="dark-logo" aria-label="Dark Logo" href="<?php echo esc_url( home_url( '/' ) );?>"><?php echo wp_kses( $tripfery_light_logo, 'allow_link' ); ?></a>
				</div>
			</div>
