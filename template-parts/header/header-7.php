	...
	<div class="container">
		<div class="menu-full-wrap">
			...
			<div class="header-icon-area header-top-icon">
				<?php if ( TripferyTheme::$options['email_icon'] || TripferyTheme::$options['opening_icon'] || TripferyTheme::$options['phone_icon'] ) { ?>
				...
				<?php } ?>
				<?php if ( TripferyTheme::$options['cart_icon'] || TripferyTheme::$options['vertical_menu_icon'] ) { ?>
...
<div class="header-menu header-bottom" id="header-menu">
	<div class="container">
		<div class="menu-full-wrap header-dark">
			...
			<?php if ( TripferyTheme::$options['search_icon'] || TripferyTheme::$options['online_button'] ) { ?>
