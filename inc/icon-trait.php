...
trait IconTrait {
  ...
  {
    return [
        "icon-tripfery-instagram"  => "instagram",
        "icon-tripfery-left-arrow"  => "left-arrow",
        "icon-tripfery-right-arrow"  => "right-arrow",
        "icon-tripfery-location"  => "location",
        "icon-tripfery-message"  => "message",
        "icon-tripfery-maintain"  => "maintain",
        "icon-tripfery-petroleum"  => "petroleum",
        "icon-tripfery-quality-control"  => "quality-control",
        "icon-tripfery-painter"  => "painter",
        "icon-tripfery-pdf"  => "pdf",
        "icon-tripfery-phone"  => "phone",
        "icon-tripfery-pinterest"  => "pinterest",
        "icon-tripfery-play"  => "play",
        "icon-tripfery-plus"  => "plus",
        "icon-tripfery-power"  => "power",
        ...
        "icon-tripfery-tags"  => "tags",
        "icon-tripfery-testing"  => "testing",
        "icon-tripfery-time"  => "time",
        "icon-tripfery-twitter"  => "twitter",
        "icon-tripfery-user"  => "user",
        "icon-tripfery-up-arrow"  => "up-arrow",
        "icon-tripfery-whatsapp"  => "whatsapp",
        "icon-tripfery-worker"  => "worker",
        "icon-tripfery-youtube"  => "youtube",
        "icon-tripfery-angle-down"  => "angle-down",
        "icon-tripfery-angle-left"  => "angle-left",
        "icon-tripfery-angle-right"  => "angle-right",
        "icon-tripfery-angle-up"  => "angle-up",
        "icon-tripfery-architecture"  => "architecture",
        "icon-tripfery-automotive"  => "automotive",
        "icon-tripfery-calendar"  => "calendar",
        "icon-tripfery-calendar-alt"  => "calendar-alt",
        "icon-tripfery-cart"  => "cart",
        "icon-tripfery-check"  => "check",
        "icon-tripfery-comment"  => "comment",
        "icon-tripfery-compare"  => "compare",
        "icon-tripfery-construction"  => "construction",
        "icon-tripfery-docs"  => "docs",
        "icon-tripfery-facebook"  => "facebook",
        "icon-tripfery-heart" => "heart",
    ];
  }
