...
if( ! function_exists( 'tripfery_breadcrumbs' )){

	function tripfery_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'tripfery' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){
				...
				if ( get_post_type() == 'post' ){
					...
					$category = tripfery_get_primary_category_id();
					$category = get_category( $category );
